        ...
        <form action="" method="POST">
            <table class="tlb-30">
                ...
                <tr>
                    <td>Phone: </td>
                    <td>
                        <input type="text" name="phone" placeholder="Nhap SDT">
                    </td>
                </tr>
                <tr>
                    <td>Email: </td>
...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `tbl_user` (`id`, `full_name`, `phone`, `email`, `password`, `level`) 
    VALUES (NULL, '$fullname', '$phone', '$email', '$password', 1);";
